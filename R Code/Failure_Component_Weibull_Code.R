mydatatry4<- read.csv("C:/Users/Nirbhay Pherwani/Desktop/Nirbhay_Final/sample2.csv")
attach(mydatatry4)
# Define variables
time <- Spell
event <- event
z <- cbind(Failure.Code,Model.Family.Desc,Part.Desc)
group <- Part.Desc
...
legend('right',paste('Part',1:6), col=1:6, lty=1, cex=.8, bty='n')
